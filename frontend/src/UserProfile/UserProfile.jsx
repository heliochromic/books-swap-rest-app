...
const UserProfile = () => {
    ...
    const handleRatingSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.get(`http://localhost:8000/api/profile/${id}`, getConfig());
            setProfileData({ ...profileData, rating: response.data.rating });
    ...
    const imageUrl = profileData.image ? `${profileData.image}` : 'http://localhost:8000/media/images/users/default.png';
    ...
    return (
        <div className="d-flex flex-column justify-content-center align-items-center mt-5">
            ...
            <div className="profile-details">
                {((me.djuser.is_staff && profileData.djuser) || profileData.has_exchanged) &&
